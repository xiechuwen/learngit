...
<link href="/css/addMessage.css" rel="stylesheet" type="text/css" />
	...
	<div id="container">
			<div id="left">
				...
				<div id=left-middle>
					...
					<div class="midle-select">dealMessageInfo</div>
			...
			<div id="right">
				...
				<iframe name="left" id="rightMain" src="" frameborder="false" scrolling="auto" style="border:none;" width="100%" height="100%" allowtransparency="true">
	...
	<form action="addMessageInforMation" name="claimForm" enctype="multipart/form-data" method="post">				
				...
				<div id="right-form">
					...
					<div id="type">
						...
						<div class="type-input"><select name="message.messageType" id="classifys" style="width:300px;text-align: center;margin-top:6px"  onChange="getNextClassify()">
			...
			<!-- 提交多个详情 -->
					...
					<div id="detail-info" style="">
						...
						<div class="info-type">
							<select name="Details.detailStype" style="width:150px;height:40px;text-align: center;margin-top: 10px;"  id="detailStype" >
								<!-- <option value="">请选择</option>   -->
							</select>
			
  					   </div>  	
				
						<div class="info-info"><input name="Details.messageInfo" id="messageInfo" placeholder="请输入您遇到的问题（详情）"style="width:650px;height:30px;margin-top: 10px"/></div>
						<div id="add" style="font-size:14px;color:white" onclick="add_tr(this)">添加</div>
						<div id="remove"style="font-size:14px;color:white">删除</div>
					<!-- <div id="remove"style="font-size:14px;color:white"><input type="button" style="width:100%;height: 100%;line-height:15px" value="删除" /></div> -->
